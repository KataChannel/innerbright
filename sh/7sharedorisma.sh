...
# innerbright.vn Shared Prisma Setup Script
...
{
  "name": "@innerbright.vn/shared",
  "version": "1.0.0",
  "description": "Shared Prisma configuration for innerbright.vn",
  "main": "lib/prisma.ts",
  "dependencies": {
...
DATABASE_URL="postgresql://innerbright.vn:innerbright.vn123@localhost:5432/innerbright.vn_db"
