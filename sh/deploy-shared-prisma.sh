...
show_banner() {
    echo ""
    echo "🚀 innerbright.vn Enhanced Deployment with Shared Prisma"
    echo "=================================================="
    echo ""
}
...
check_prerequisites() {
    ...
    if [[ ! -f "package.json" ]] || [[ ! -f "docker-compose.yml" ]]; then
        error "Please run this script from the innerbright.vn root directory"
    fi
...
main() {
    ...
    success "🚀 innerbright.vn deployment with shared Prisma completed successfully!"
}
