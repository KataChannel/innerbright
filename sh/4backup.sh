...
prompt_input "PostgreSQL container name" "${POSTGRES_CONTAINER:-innerbrightv1-postgres}" "POSTGRES_CONTAINER"
...
# Redis configuration
prompt_input "Redis container name" "${REDIS_CONTAINER:-innerbrightv1-redis}" "REDIS_CONTAINER"

# MinIO configuration
prompt_input "MinIO container name" "${MINIO_CONTAINER:-innerbrightv1-minio}" "MINIO_CONTAINER"

# API configuration
prompt_input "API container name" "${API_CONTAINER:-innerbrightv1-api}" "API_CONTAINER"
