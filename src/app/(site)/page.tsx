                        ...
                        <div className="container mx-auto px-8 lg:px-12">
                          <div className="max-w-2xl">
                            ...
                            <p className="text-sm lg:text-base text-white/90 leading-relaxed">
                              Tạo dựng cuộc sống thịnh vượng hơn cho người người
                              Việt Nam bằng việc khai phóng tiềm năng và giúp
                      ...
                      <div className="absolute inset-0 flex items-center">
                        <div className="container mx-auto px-8 lg:px-12">
                          <div className="max-w-2xl">
                            ...
                            <p className="text-sm lg:text-base text-white/90 leading-relaxed">
                              Trang bị cho mỗi người Việt Nam đủ sở hữu tư duy
                              phát triển bản thân đúng đắn, hiệu quả và bền
                              vững.
                            </p>
                          </div>
                        </div>
        ...
        <SlideIn direction="up" delay={0.2}>
          <Section className="text-center">
            ...
            <p className="text-gray-700 mb-4">
              Thế giới của mỗi người chính là bề sinh trắc, nơi mỗi chúng ta
              sống và làm việc cùng các cộng đồng. Tại InnerBright, điều quan
              trọng không chỉ là được thành công cá nhân, mà còn là sử dụng sức
              mạnh này để tạo ra sự khác biệt và ảnh hưởng đến hệ sinh thái của
              riêng bạn. Bằng cách phát triển bản thân, chúng ta tự trở thành
              người cầm trịch và sẽ thay đổi cả thế giới.
            </p>
            <p className="text-gray-700 font-semibold">
              Chúng tôi - những con người tại InnerBright rất tự hào và sẵn sàng
              đồng hành cùng bạn trên hành trình này để khai phóng tiềm năng và
              giúp phát huy tối đa nội lực của riêng Bạn
            </p>
          </Section>
        </SlideIn>
            ...
            <StaggerContainer staggerDelay={0.2}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <StaggerItem>
                  <div className="p-6 bg-gray-50 rounded-lg shadow-md">
                    <p className="text-gray-700 mb-4">
                      ...
                      thức và uy tín của Hiệp Hội NLP Hoa Kỳ (ABNLP) trong hơn 5
                      năm liên tục. ABNLP với vai trò là tổ chức lớn nhất và lâu
                      đời nhất về Lập Trình Ngôn Ngữ Tư Duy (NLP - Neuro
                      Linguistic Programming) tại Hoa Kỳ, có chứng nhận sự
                      chuyên nghiệp và chất lượng đào tạo của InnerBright.
                    </p>
                ...
                <StaggerItem>
                  <div className="p-6 bg-gray-50 rounded-lg shadow-md">
                    <p className="text-gray-700 mb-4">
                      Đặc biệt, InnerBright là đơn vị tiên phong tại Việt Nam
                      được Ban Cố Vấn (Board of Advisors) của Hiệp Hội ABNLP
                      chứng thực bằng chương trình NLP Master Coach Quốc Tế.
                      Điều này đảm bảo rằng không chỉ về kiến thức chuyên môn,
                      mà còn về đạo đức nghề nghiệp, InnerBright mang đến chương
                ...
                <div className="container mx-auto px-8 lg:px-12">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                      ...
                      thuật, mà là một hành trình khám phá sức mạnh nội tại để
                      tạo ra sự chuyển hóa sâu sắc. Để ứng dụng NLP hiệu quả, sự
                      thấu hiểu cội nguồn và nguyên lý hoạt động là then chốt.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-8 justify-center">
              ...
              <div className="text-gray-700">
                ...
                <p className="text-sm md:text-base leading-relaxed mb-4">
                  chúng tôi không chỉ trang bị cho bạn kiến thức NLP; chúng tôi
                  dẫn dắt bạn thực sự thấu suốt bản chất của từng công cụ. Bạn
                  sẽ hiểu tại sao chúng hoạt động, khi nào nên sử dụng và làm
                  thế nào để tích hợp chúng một cách linh hoạt vào cuộc sống.
                </p>
              </div>
            </div>
            <div className="bg-white mt-16">
              <p className="mb-4">
                Với tâm huyết truyền tải tinh thần chính trực của NLP,
                InnerBright không đơn thuần mang đến một hệ thống bài bản. Chúng
                tôi kiến tạo một hành trình phát triển bản thân toàn diện, hấp
                nhất sức mạnh nội tại của bạn với sự trưởng thành ở cả bốn khía
                cạnh then chốt: trí tuệ lý trí (mental intelligence), trí tuệ
                cảm xúc (emotional intelligence), trí tuệ thể chất (physical
                intelligence) và trí tuệ tâm linh (spiritual intelligence).
              </p>
              <p>
                Chúng tôi nuôi dưỡng những giá trị cốt lõi của bạn, tạo nên một
                hệ sinh thái nội tại vụng mạnh và bền vững, giúp bạn phát triển
                toàn diện và sống một cuộc đời trọn vẹn.
              </p>
            </div>
          </Section>
        </SlideIn>
            ...
            <div className="min-h-screen bg-gray-50 font-sans">
              <div className="container mx-auto px-4 py-12 max-w-5xl">
                ...
                <section className="mb-12">
                  ...
                  <div className="relative bg-white rounded-lg shadow-lg p-6 md:p-8 overflow-hidden">
                    {/* Background image */}
                    <div className="absolute inset-0 z-0">
                      <img
                        src="images/about/doinguchuyengia.jpg"
                        alt="Background"
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
                      ...
                      <div className="md:w-2/3 text-gray-700">
                        ...
                        <p className="text-sm md:text-base leading-relaxed">
                          Trong quá trình học tập và huấn luyện tại Việt Nam,
                          Chloe Quý Châu là chuyên gia nguyên vật liệu, kiến
                          trúc ABNLP Coaching Division cấp phép đào tạo NLP
                          Master Coach. Chloe tập trung truyền tải nguyên bản
                          công cụ NLP để học viên hiểu rõ, đúng, đủ và ứng dụng
                          linh hoạt vào cuộc sống.
                        </p>
                        <p className="text-sm md:text-base leading-relaxed mt-2">
                          Chloe cũng là một trong số ít người Việt đầu tiên được
                          chứng nhận đào tạo Time Line Therapy® trực tiếp từ
                          hiệp hội, một phương pháp mạnh mẽ giúp xử lý sâu sắc
                          các cảm xúc tiêu cực và niềm tin giới hạn.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <section className="text-center mb-12">
                  <p className="text-gray-700 text-sm md:text-base leading-relaxed mb-8">
                    Hành trình chuyên nghiệp của Chloe được xây dựng trên nền
                    tảng kinh nghiệm khai vấn (coaching) được chứng nhận bởi
                    hàng loạt các tổ chức uy tín trên thế giới, bao gồm:
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-600 text-sm">
                        Chứng nhận khả năng huấn luyện và phát triển doanh
                        nghiệp.
                      </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-600 text-sm">
                        Chứng nhận năng lực trị liệu và khai vấn bằng kỹ thuật
                        Time Line Therapy.
                      </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                      ...
                      <h4 className="font-semibold text-lg text-gray-800 mb-2">
                        Tư vấn hình ảnh First Impressions Image
                      </h4>
                      <p className="text-gray-600 text-sm">
                        Chứng nhận chuyên môn tư vấn hình ảnh cá nhân và doanh
                        nghiệp.
                      </p>
                    </div>
                  </div>
