  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans antialiased">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto py-8">
          ...
          <p className="text-lg sm:text-xl text-gray-700 leading-relaxed">
            Một cách đơn giản, thuật ngữ "Lập trình ngôn ngữ tư duy" đề cập đến
            những chương trình chạy ngầm trong tiềm thức, dẫn dắt hành vi và tạo
            ra kết quả trong cuộc sống của chúng ta.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              người có trung bình dao động từ 80 đến 100 tỷ nơ-ron và 100 tỷ tế
              bào nơ-ron thần kinh, hoạt động chính của nó là giúp chúng ta có
              thể tiếp nhận, xử lý thông tin. Sau đó bộ não sẽ tạo ra các thiết
              lập và hệ thống phản hồi làm việc một cách hiệu quả hơn trong cuộc
              sống.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-green-500">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cách chúng ta sử dụng ngôn từ không chỉ đơn thuần diễn đạt ý định
              của chúng ta mà còn thể hiện niềm tin và thái độ của mỗi người.
              Một lời nói có thể mang năng lượng tích cực, có thể mang năng
              lượng tiêu cực. Một lời nói có thể mang năng lượng tiêu cực, một
              lời nói có thể mang năng lượng tiêu cực. Một lời nói có thể mang
              năng lượng tiêu cực. Một lời nói có thể mang năng lượng tiêu cực.
              Một lời nói có thể mang năng lượng tiêu cực. Một lời nói có thể
              mang năng lượng tiêu cực. Một lời nói có thể mang năng lượng tiêu
              cực.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-purple-500">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              dòng hóa các phản ứng thông tin và hành vi. Nó là một tập hợp các
              nguyên tắc giúp điều chỉnh các kiểu tiết niệu và hành vi không
              mong muốn, đồng thời hay mới lạ. Có thể hóa số chương trình tư duy
              và hành vi để đạt được hiệu quả hơn.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(https://placehold.co/1200x400/A0A0A0/FFFFFF)`,
        }}
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg sm:text-xl leading-relaxed">
            ...
            biến chúng ta thành những thực thể mới. Hay nói cách khác, bộ não là
            hệ điều hành của cuộc sống. NLP giúp thay đổi cách chúng ta nghĩ về
            bản thân, về người khác, về thế giới và thay thế bằng những điều hữu
            ích cho cuộc sống. NLP giúp tái cấu trúc những chương trình chạy
            ngầm bên trong, từ đó thay đổi tư duy và hành vi để đạt được hiệu
            quả.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
          <div className="relative max-w-4xl mx-auto text-center justify-center">
            ...
            <p className="text-justify text-lg sm:text-xl leading-relaxed">
              Bạn đang tham gia vào hành trình thấu hiểu bản thân, tìm thấy mục
              tiêu cuộc sống và làm chủ chính mình. Đây cũng là hành trình giúp
              Bạn chữa lành những tổn thương bên trong từ gốc rễ ở quá khứ, từ
              đó giúp kết nối mối quan hệ với bản thân, loại bỏ rào cản hoài
              nghi năng lực cá nhân, cải thiện khả năng tương tác thấu cảm với
              người khác; cung cấp cho bạn một loạt các chiến lược gia tăng hiệu
              suất cá nhân lâu dài, và một hành trình phát triển bản thân đúng
              đắn và toàn diện. Đến nay, NLP đã phát triển các công cụ và kỹ
              năng rất mạnh mẽ và tạo thay đổi trong nhiều lĩnh vực chuyên môn
              bao gồm: tư vấn, tâm lý trị liệu, giáo dục, sức khỏe, sáng tạo,
              luật, quản lý, bán hàng, lãnh đạo và nuôi dạy con cái.
            </p>
          </div>
          <div className="p-4">
            <img
   ...
   <Section>
      <div className="w-full bg-white shadow-lg rounded-xl p-6 sm:p-8 lg:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            ...
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">Milton Erickson (1901-80)</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              là một bác sĩ tâm thần, nhà trị liệu thôi miên rất thành công. NLP dựa trên cách mà Milton Erickson sử dụng ngôn ngữ thôi miên trị liệu để tạo nên các mẫu ngôn ngữ mang tên Mô hình Milton. Bất kể bạn đang ở bất cảnh nào, vai trò của bạn là gì thì những mẫu ngôn ngữ này sẽ giúp cho bạn có thể gia tăng khả năng giao tiếp với tầng tiềm thức của người nghe, thúc đẩy động lực, gây sự ảnh hưởng và tạo ra sự thay đổi lâu dài mang tính tích cực.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            ...
            <img
              ...
              className="w-32 h-32 sm:w-36 sm:h-36 rounded-full object-cover mb-4 border-4 border-blue-500 shadow-md"
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">Fritz Perls (1893-70)</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              là một bác sĩ phẫu thuật thần kinh người Đức và nhà phân tâm học gốc Do Thái. Ông cũng là người người sáng lập ra liệu pháp Gestalt. Ông được đóng góp phát triển thành một công cụ trị liệu để phân tích tâm lý.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            ...
            <img
              ...
              className="w-32 h-32 sm:w-36 sm:h-36 rounded-full object-cover mb-4 border-4 border-blue-500 shadow-md"
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">Virginia Satir (1916-88)</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
     ...
     <div className="w-full bg-white shadow-lg rounded-xl p-6 sm:p-8 lg:p-10">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-gray-800 mb-10 mt-16 leading-tight">
          NHỮNG NGƯỜI TIẾP NỐI VÀ PHÁT TRIỂN NLP: CHẮP CÁNH CHO MỘT LĨNH VỰC MANG TẦM ẢNH HƯỞNG TO LỚN
        </h2>

        <p className="text-base sm:text-lg lg:text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto leading-relaxed">
          Kể từ khi được Richard Bandler và John Grinder giới thiệu vào những năm 1970, NLP đã trải qua quá trình phát triển mạnh mẽ với sự đóng góp của nhiều nhà nghiên cứu và thực hành xuất sắc. Họ đã tiếp nối và phát triển NLP thành những công cụ thực tiễn, dễ ứng dụng, mang lại lợi ích to lớn cho con người trong nhiều lĩnh vực. Dưới đây là một số nhân vật tiêu biểu:
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            <img
              ...
              className="w-32 h-32 sm:w-36 sm:h-36 rounded-full object-cover mb-4 border-4 border-blue-500 shadow-md"
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">TAD JAMES</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            <img
              ...
              className="w-32 h-32 sm:w-36 sm:h-36 rounded-full object-cover mb-4 border-4 border-blue-500 shadow-md"
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">ROBERT DILTS</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300">
            <img
              ...
              className="w-32 h-32 sm:w-36 sm:h-36 rounded-full object-cover mb-4 border-4 border-blue-500 shadow-md"
            />
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2">ANTHONY ROBBINS</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
      <img
        ...
        onError={(e) => {
          ...
          target.onerror = null;
          target.src =
            "https://placehold.co/300x200/E0E0E0/666666";
        }}
      />
      <div className="p-6">
