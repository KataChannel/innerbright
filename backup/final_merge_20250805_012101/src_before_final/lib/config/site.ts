export const siteConfig = {
    title: "InnerBright Training & Coaching",
    description: "Khai phóng tiềm năng và phát huy tối đa nội lực của mỗi cá nhân thông qua NLP và Time Line Therapy",
    url: "https://innerbright.vn",
    author: {
        name: "Chloe Quý Châu",
        url: "https://innerbright.vn/about"
    },
    keywords: [
        "NLP",
    ...
    maintenance: {
        ...
        allowedUsers: ["admin@innerbright.vn", "chloe@innerbright.vn"],
