...
# 🚀 innerbright Production Deployment Script
...
readonly PROJECT_NAME="innerbright"
...
For more information, visit: https://docs.tazaofficial.com/deployment
EOF
}

# Version information
show_version() {
    echo "innerbright Production Deployment Script"
...
main() {
    ...
    log "Starting innerbright deployment..."
