...
export default function BoTheNLPPage() {
	return (
		<ScaleWrapper height={7040}>
			...
			<div id="Bo_the_NLP">
				<svg className="aac">
					<rect id="aac" rx="0" ry="0" x="0" y="0" width="1920" height="1849" />
				...
				<div id="abe">
					...
					<div id="abo">
						<span>Cuộc sống của Bạn là do chính Bạn tạo ra và Lập Trình Ngôn Ngữ Tư Duy - NLP (Neuro Linguistic Programming) là chìa khóa giúp Bạn khai phá sức mạnh của bản thân để hiện thực hoá những kết quả mà Bạn mong muốn.</span>
					</div>
				</div>
				<div id="abp">
					<div id="abq">
					...
					<div id="abr">
						<span>THAY ĐỔI THẾ GIỚI</span>
					</div>
					<div id="abs">
						<span>Là sức mạnh để</span>
					</div>
				</div>
				<div id="abt">
					<svg className="abu">
						<rect id="abu" rx="0" ry="0" x="0" y="0" width="1920" height="794" />
					...
					<div id="acd">
						<span>Phát huy sự tự tin</span>
					</div>
					<div id="ace">
						<span>Trở thành người khai<br />phóng tiềm năng</span>
					</div>
					<div id="acf">
						<span>Xây dựng những mối quan hệ <br />chất lượng là chất liệu tạo nên <br />hạnh phúc và thành công của <br />bất kỳ cá nhân hay tổ chức nào.</span>
					</div>
					<div id="acg">
						<span>Phá vỡ những điểm mù, và phát huy những tiềm năng tuyệt vời từ bản thân và người khác bằng năng lực coaching.</span>
					</div>
					<div id="ach">
						<span>Kết nối với mục đích sống của bản thân để sự tự tin của bạn không thể lay chuyển trong mọi tình huống.</span>
					</div>
				</div>
				<div id="aci">
					<svg className="acj">
						<rect id="acj" rx="0" ry="0" x="0" y="0" width="1920" height="750" />

					</svg>
					<svg className="ack">
						<rect id="ack" rx="0" ry="0" x="0" y="0" width="1920" height="526" />

					</svg>
					<div id="acl">
						<span>BỘ THẺ ỨNG DỤNG NLP HOÀN CHỈNH</span>
					</div>
					<div id="acm">
				...
				<div id="acv">
					<svg className="acw">
						<rect id="acw" rx="0" ry="0" x="0" y="0" width="1920" height="657" />
				...
				<div id="adq">
					<svg className="adr">
						<rect id="adr" rx="0" ry="0" x="0" y="0" width="1920" height="698" />

					</svg>
					<svg className="ads">
						<rect id="ads" rx="48" ry="48" x="0" y="0" width="1400" height="601" />

					</svg>
					<div id="adt">
						<span>I  FROM ĐĂNG KÝ  I</span>
					</div>
					<div id="adu">
						<span>ĐĂNG KÝ NHẬN TƯ VẤN</span>
					</div>
					<svg className="adv">
						<rect id="adv" rx="12" ry="12" x="0" y="0" width="580" height="434" />

					</svg>
					<svg className="adw">
						<rect id="adw" rx="15" ry="15" x="0" y="0" width="519" height="49" />
					...
					<svg className="ady">
						<rect id="ady" rx="15" ry="15" x="0" y="0" width="519" height="49" />
					...
					<svg className="aea">
						<rect id="aea" rx="15" ry="15" x="0" y="0" width="519" height="49" />

					</svg>
					<div id="aeb">
						<span>SĐT (Bắt buộc)</span>
					</div>
					<svg className="aec">
						<rect id="aec" rx="15" ry="15" x="0" y="0" width="519" height="130" />

					</svg>
					<div id="aed">
						<span>Họ tên (không bắt buộc)</span>
					</div>
					<div id="aee">
						<span>T</span>
					</div>
					<div id="aef">
						<svg className="aeg">
							<rect id="aeg" rx="29.5" ry="29.5" x="0" y="0" width="320" height="59" />
				...
				<div id="aej">
					<svg className="aek">
						<rect id="aek" rx="0" ry="0" x="0" y="0" width="1920" height="805" />

					</svg>
					<div id="ael">
						<span>Ý NGHĨA CỦA BỘ THẺ</span>
					</div>
					<div id="aem">
						<span>Bộ thẻ gồm 45 thẻ này là một công cụ hỗ trợ tuyệt vời cho Bạn khi thực hành NLP hoặc đang ở những bước đầu tiên quan tâm đến phương pháp chuyển hoá nội lực mạnh mẽ này.</span>
					</div>
					<div id="aen">
