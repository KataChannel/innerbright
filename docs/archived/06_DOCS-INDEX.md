# 📚 innerbright Documentation Index

Welcome to the innerbright documentation! This guide will help you navigate through all available documentation.
...
- **GitHub Repository**: [innerbright on GitHub](https://github.com/TazaChannel/innerbright)
- **Live Demo**: [http://116.118.85.41:3000](http://116.118.85.41:3000)
- **API Demo**: [http://116.118.85.41:3001](http://116.118.85.41:3001)
- **Database Admin**: [http://116.118.85.41:5050](http://116.118.85.41:5050)
...
4. **Bug Reports**: [Create GitHub Issue](https://github.com/TazaChannel/innerbright/issues)
5. **Feature Requests**: [GitHub Discussions](https://github.com/TazaChannel/innerbright/discussions)
