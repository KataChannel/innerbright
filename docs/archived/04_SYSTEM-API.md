# ⚙️ innerbright System API Documentation

## Overview
The innerbright System API provides administrative and system-level functionality for managing the innerbright platform. This includes system monitoring, configuration management, user administration, and platform analytics.
  ...
  "data": {
    "config": {
      ...
      "security": {
        ...
        "cors": {
          "enabled": true,
          "origins": ["https://app.innerbright.com"]
        }
      },
      "notifications": {
        "email": {
          "enabled": true,
          "provider": "sendgrid",
          "fromAddress": "noreply@innerbright.com"
        },
        "sms": {
          "enabled": true,
          "provider": "twilio"
...
### Node.js Admin SDK
```javascript
const { SystemAPI } = require('@innerbright/system-api');
...
### Python Admin SDK
```python
from innerbright_system import SystemAPI
...
- 📧 Email: system-support@innerbright.com
- 📚 Documentation: https://docs.innerbright.com/api/system
- 🚨 Critical Issues: emergency@innerbright.com
