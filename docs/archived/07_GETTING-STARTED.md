# 🚀 innerbright Enterprise Platform - Getting Started

Welcome to **innerbright**, your complete enterprise platform solution! This guide will help you set up and start using innerbright in just a few minutes.

## 🎯 What is innerbright?

innerbright is a modern, full-stack enterprise platform that includes:
...
innerbright uses PostgreSQL with Prisma ORM. The database schema includes:
...
```bash
# Access database
docker-compose exec postgres psql -U innerbright

# Backup database
docker-compose exec postgres pg_dump -U innerbright innerbright > backup.sql

# Restore database
docker-compose exec postgres psql -U innerbright innerbright < backup.sql
```
...
- **Email Support**: support@innerbright.com
