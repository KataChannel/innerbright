# 🏢 innerbright HRM API Documentation

## Overview
The innerbright HRM (Human Resource Management) API provides comprehensive endpoints for managing employee data, organizational structure, and HR processes within the innerbright platform.
...
### Postman Collection
A comprehensive Postman collection is available at `/docs/examples/innerbright-HRM-API.postman_collection.json`

### Test Credentials
For testing purposes, you can use the following credentials:
- **API Key**: `test_api_key_123456`
- **Base URL**: `https://demo.innerbright.com/api/hrm`

### Example Test Cases
```bash
# Test authentication
curl -X GET "https://demo.innerbright.com/api/hrm/employees" \
  -H "Authorization: Bearer test_api_key_123456"

# Test employee creation
curl -X POST "https://demo.innerbright.com/api/hrm/employees" \
  -H "Authorization: Bearer test_api_key_123456" \
...
- 📧 Email: api-support@innerbright.com
- 📚 Documentation: https://docs.innerbright.com/api/hrm
- 🐛 Bug Reports: https://github.com/innerbright/issues
