    ...
    const role = await prisma.roles.create({
      data: {
        ...
        permissions: JSON.stringify({
          ...
          isSystemRole: true,
          source: 'Innerbright Unified Seed'
        }),
        level: roleData.level,
...
function getRoleDescription(roleName: string): string {
  const descriptions: Record<string, string> = {
    'SUPER_ADMIN': 'Super Administrator với quyền tối cao trong hệ thống Innerbright',
...
/**
 * Create system users including Super Admin with it@innerbright.vn
 */
async function seedSystemUsers(roles: any) {
  ...
  const superAdmin = await prisma.users.create({
    data: {
      ...
      phone: '+84900000000',
      displayName: 'Innerbright IT Administrator',
  ...
  const departments = await Promise.all([
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 3-4, Innerbright Tower',
        phone: '+84901234500',
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 2, Innerbright Tower',
        phone: '+84901234501',
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 1, Innerbright Tower',
        phone: '+84901234502',
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 5, Innerbright Tower',
        phone: '+84901234503',
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 6, Innerbright Tower',
        phone: '+84901234504',
    ...
    prisma.departments.create({
      data: {
        ...
        location: 'Floor 3, Innerbright Tower',
        phone: '+84901234505',
  ...
  const managers = await Promise.all([
    ...
    prisma.users.create({
      data: {
        ...
        username: 'innerbright_qa_manager',
        phone: '+84901000006',
        ...
        bio: 'QA Manager - Quản lý Đảm bảo Chất lượng Innerbright',
        isVerified: true,
        isActive: true,
        status: UserStatus.ONLINE,
        roleId: roles.department_managerRole.id,
...
async function seedEmployees(roles: any, departments: any, positions: any) {
  ...
  const employees = await Promise.all([
    ...
    prisma.users.create({
      data: {
        email: 'devops@innerbright.vn',
        username: 'innerbright_devops',
        phone: '+84902000003',
    ...
    prisma.users.create({
      data: {
        email: 'ops1@innerbright.vn',
        username: 'innerbright_ops1',
        phone: '+84902000008',
    ...
    prisma.users.create({
      data: {
        email: 'qa1@innerbright.vn',
        username: 'innerbright_qa1',
        phone: '+84902000009',
...
async function seedEmployeeRecords(allUsers: any, departments: any, positions: any) {
  ...
  const departmentMapping: Record<string, string> = {
    'cto@innerbright.vn': departments.techDepartment.id,
    'hr.director@innerbright.vn': departments.hrDepartment.id,
    'sales.director@innerbright.vn': departments.salesDepartment.id,
    'finance.manager@innerbright.vn': departments.financeDepartment.id,
    'ops.manager@innerbright.vn': departments.operationsDepartment.id,
    'qa.manager@innerbright.vn': departments.qaDepartment.id,
    'dev1@innerbright.vn': departments.techDepartment.id,
    'dev2@innerbright.vn': departments.techDepartment.id,
    'devops@innerbright.vn': departments.techDepartment.id,
    'hr1@innerbright.vn': departments.hrDepartment.id,
    'sales1@innerbright.vn': departments.salesDepartment.id,
    'sales2@innerbright.vn': departments.salesDepartment.id,
    'accountant1@innerbright.vn': departments.financeDepartment.id,
    'ops1@innerbright.vn': departments.operationsDepartment.id,
    'qa1@innerbright.vn': departments.qaDepartment.id,
  };

  const positionMapping: Record<string, string> = {
    'cto@innerbright.vn': positions[0].id, // CTO
    'hr.director@innerbright.vn': positions[3].id, // HR Director
    'sales.director@innerbright.vn': positions[6].id, // Sales Director
    'finance.manager@innerbright.vn': positions[9].id, // Finance Manager
    'ops.manager@innerbright.vn': positions[11].id, // Operations Manager
    'qa.manager@innerbright.vn': positions[12].id, // QA Manager
    'dev1@innerbright.vn': positions[1].id, // Senior Software Engineer
    'dev2@innerbright.vn': positions[1].id, // Senior Software Engineer
    'devops@innerbright.vn': positions[2].id, // DevOps Engineer
    'hr1@innerbright.vn': positions[5].id, // HR Specialist
    'sales1@innerbright.vn': positions[8].id, // Senior Sales Executive
    'sales2@innerbright.vn': positions[8].id, // Senior Sales Executive
    'accountant1@innerbright.vn': positions[10].id, // Senior Accountant
    'ops1@innerbright.vn': positions[11].id, // Operations Manager
    'qa1@innerbright.vn': positions[12].id, // QA Manager
  };
...
async function seedAffiliateData(users: any) {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    const affiliate = await prisma.affiliates.create({
      data: {
        userId: user.id,
        affiliateCode: `INNERBRIGHT${1000 + i}`,
 ...
 */
async function main() {
  console.log(`${colors.bright}${colors.cyan}🌱 Innerbright Unified Comprehensive Seed Starting...${colors.reset}\n`);
  ...
  try {
    ...
    console.log(`\n${colors.bright}${colors.green}🎉 Innerbright Unified Seed Completed Successfully!${colors.reset}\n`);
    ...
    console.log(`   ${colors.red}Super Admin:${colors.reset} it@innerbright.vn / Innerbright@2024!`);
