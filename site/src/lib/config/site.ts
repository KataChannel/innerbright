export const siteConfig = {
  title: 'Innerbright - Monochrome UI',
  ...
  logo: {
    ...
    alt: 'Innerbright - Monochrome UI System',
  },
  ...
  seo: {
    ...
    description: 'Innerbright - Hệ thống giao diện đơn sắc với hỗ trợ đa ngôn ngữ và chế độ tối.',
    keywords: [
      'monochrome ui',
      'dark mode',
      'multi-language',
  ...
  author: {
    ...
    email: 'contact@innerbright.com',
    url: 'https://innerbright.com',
    social: {
      twitter: '@innerbright',
      github: 'innerbright',
      linkedin: 'innerbright',
    },
  },
