        ...
        <div className="border-y py-4 container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            ...
            <ul className="space-y-2 text-gray-700">
              <li><a href="#" className="hover:underline">Our Support</a></li>
              <li><a href="#" className="hover:underline">Blog</a></li>
              <li><a href="#" className="hover:underline">Contact us</a></li>
              <li><a href="#" className="hover:underline">Write For Us</a></li>
              <li><a href="#" className="hover:underline">Group</a></li>
            </ul>
          </div>

          {/* OUR SERVICES Navigation */}
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            <h3 className="font-bold text-lg mb-4 text-gray-800">OUR SERVICES</h3>
            <ul className="space-y-2 text-gray-700">
              <li><a href="#" className="hover:underline">Đào tạo doanh nghiệp</a></li>
              <li><a href="#" className="hover:underline">Khai vấn cá nhân</a></li>
              <li><a href="#" className="hover:underline">Đào tạo doanh nghiệp</a></li>
              <li><a href="#" className="hover:underline">Khai vấn cá nhân</a></li>
              <li><a href="#" className="hover:underline">Đào tạo doanh nghiệp</a></li>
            </ul>
