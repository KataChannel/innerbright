    ...
    >
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Hướng dẫn áp dụng cho tất cả người dùng đã đăng ký tài khoản trên nền tảng innerbrightoffical
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <div className="mb-4">
              ...
              <ol className="list-decimal list-inside space-y-2 pl-4 text-gray-700 dark:text-gray-300">
                <li>
                  Đăng nhập vào tài khoản của bạn trên innerbrightoffical qua trang web innerbright.vn
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 pl-4 text-gray-700 dark:text-gray-300">
              ...
              <li>
                Liên hệ với chúng tôi để được hỗ trợ qua it@innerbright.vn hoặc
                0906447889.
              </li>
            </ul>
          </div>
