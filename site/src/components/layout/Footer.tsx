...
// Default values
const defaultCompanyName = 'Innerbright Offical';
const defaultDescription = 'Your trusted partner in web development and digital solutions.';
const defaultContact = {
  address: '123 Innerbright Street, City, Country',
  phone: '+1 (234) 567-890',
  email: 'info@innerbrightofficial.com',
};
...
const defaultSocialLinks: SocialLink[] = [
  ...
  { name: 'Email', icon: Mail, href: 'mailto:info@innerbrightofficial.com' },
];
