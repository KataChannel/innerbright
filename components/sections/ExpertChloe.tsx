  ...
  return (
    <div id="ahi">
      ...
      <div id="ahl" className="reveal-hidden hover-premium">
        <img id="ahm" src="/ahm.png" srcSet="/ahm.png 1x, /ahm@2x.png 2x" alt="Chloe Portrait" />
      </div>
      <div id="ahn">
        <div id="aho">
          <img id="ahp" src="/ahp.png" srcSet="/ahp.png 1x, /ahp@2x.png 2x" alt="Certification" />
        </div>
        <div id="ahq">
          <span>•</span>
        </div>
        ...
        <div id="ahv">
          <img id="ahw" src="/ahw.png" srcSet="/ahw.png 1x, /ahw@2x.png 2x" alt="Logo" />
        </div>
      </div>
    </div>
  );
